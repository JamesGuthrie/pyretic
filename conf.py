...
latex_documents = [
  ('index', 'Pyretic.tex', 'Pyretic Documentation',
   'Team Pyretic', 'manual'),
]
...
man_pages = [
    ('index', 'pyretic', 'Pyretic Documentation',
     ['Team Pyretic'], 1)
]
...
texinfo_documents = [
  ('index', 'Pyretic', 'Pyretic Documentation',
   'Team Pyretic', 'Pyretic', 'One line description of project.',
   'Miscellaneous'),
]
